...
mod tests {
    ...
    use cosmwasm_std::{
        coins, from_json_binary, to_json_binary, BankMsg, CosmosMsg, Decimal, DepsMut, Response, StdError,
        Uint128,
    };
...
-----END PGP PUBLIC KEY BLOCK-----";
    ...
    fn setup_contract(deps: DepsMut<'_>) -> Cw721MetadataContract {
    ...
    fn update_minting_fees_with_base_fee() {
        ...
        let contract_query_res: ContractInfoResponse = from_json_binary(
    ...
    fn update_admin_address() {
        ...
        let contract_query_res1: MinterResponse = from_json_binary(
        ...
        let contract_query_res2: MinterResponse = from_json_binary(
            &entry::query(deps.as_ref(), mock_env(), QueryMsg::AdminAddress {}).unwrap(),
        )
        .unwrap();
    ...
    fn base_minting() {
        ...
        let paths_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::Paths {
        ...
        let base_tokens_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::BaseTokens {
    ...
    fn subdomain_minting() {
        ...
        let address_query_res: AddressOfResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::AddressOf {
        ...
        let parent_id_query_res: GetParentIdResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::GetParentId {
        ...
        let parent_id_query_res: MemeArtNftInfoResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
        ...
        let path_query_res: GetPathResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
        ...
        let deeper_path_query_res: GetPathResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::GetFullPath {
        ...
        let secret_plans_nested_token_query: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
        ...
        let secret_plans_path_query: GetPathResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::GetFullPath {
    ...
    fn path_minting() {
        ...
        let jeffvader_paths_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
        ...
        let lordvader_paths_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
        ...
        let full_path_query: GetPathResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::GetFullPath {
    ...
    fn alias_and_paths_cleared_on_send() {
        ...
        let alias_query_res: PrimaryAliasResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
        ...
        let alias_query_res_2: PrimaryAliasResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PrimaryAlias {
        ...
        let alias_query_res_3: PrimaryAliasResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PrimaryAlias {
        ...
        let jeffvader_paths_query_res_after_send: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
    ...
    fn can_transfer_path() {
        ...
        let jeffvader_basetoken_paths_query_res_after_transfer: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
        ...
        let jeffvader_all_paths_query_res_after_transfer: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::Paths {
    ...
    fn alias_and_paths_cleared_on_transfer() {
        ...
        // first check alias
        let after_failure_query_res: PrimaryAliasResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PrimaryAlias {
        ...
        let after_failure_paths_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
        ...
        let alias_query_res_5: PrimaryAliasResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PrimaryAlias {
    ...
    fn double_transfer() {
        ...
        let buyer_base_tokens_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::BaseTokens {
        ...
        let buyer_cw721_tokens_query_res: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::Tokens {
        ...
        let yoda_all_paths_query_res_after_transfer: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::Paths {
    ...
    fn alias_and_paths_cleared_on_burn() {
        ...
        let jeffvader_paths_query_res_after_failed_burn: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
        ...
        // CHECK: no path under base token
        let jeffvader_paths_query_res_after_burn: TokensResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::PathsForToken {
    ...
    fn use_metadata_extension() {
        ...
        let contract_query_res: IsContractResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::IsContract {
        ...
        let address_of_res: AddressOfResponse = from_json_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
                QueryMsg::AddressOf {
