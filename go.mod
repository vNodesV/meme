...
require (
	...
	github.com/CosmWasm/wasmvm/v2 v2.3.4
...
replace (
	...
	// Cheqd custom patches for SDK 0.50.14
	...
	github.com/ojo-network/price-feeder => github.com/cheqd/price-feeder v0.50.14-cheqd
	// Additional custom modules from cheqd
