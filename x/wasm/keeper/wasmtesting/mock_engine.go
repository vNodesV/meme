...
func (m *MockWasmer) StoreCode(codeID wasmvm.WasmCode, gasLimit uint64) (wasmvm.Checksum, uint64, error) {
...
func NoOpStoreCodeFn(_ wasmvm.WasmCode, gasLimit uint64) (wasmvm.Checksum, uint64, error) {
	_ = gasLimit
